...
<div class="container"> <!-- <div class="container"> 컨테이너를 넣어 하나의 컨테이너 처럼 감싸줌  -->
	...
	<div class="jumbotron" style="padding-top20px;">	<!-- 현재 중간라인엔 로그인 양식이 들어감  -->
		<form method="post"	action="joinAction.jsp"><!-- 이 안에는 하나의 form 양식이 들어간다. post는 회원가입,로그인 등..의 어떠한 정보를 숨기면서  보낼떄 쓰는 메소드 라고 할 수 있음. -->
		...
		<div class="form-group">
			...
			<div class="form-group" style="text-align: center;">
				...
				<label class="btn btn-primary active">
					<input type="radio" name="userGender" autocomplete="off" value="남자" checked>남
				</label>
				<label class="btn btn-primary">
					<input type="radio" name="userGender" autocomplete="off" value="여자" checked>여
				</label>
				</div>
				</div>
					<div class="form-group">
