...
<nav class="navbar navbar-default">
	...
	<div class="callapse navbar-callapse" id="bs-example-navbar-collapse-1">
		<ul class="nav navbar-nav">
			<li class="active"><a href="/Education/geunho/logon/main.jsp">메인</a></li> <!--li태그는 원소 역할을 한다-->
			<li><a href="/Education/geunho/bbs/bbs.jsp">게시판</a></li>
...
<div class="container"> <!-- <div class="container"> 컨테이너를 넣어 하나의 컨테이너 처럼 감싸줌  -->
	...
	<div class="jumbotron" style="padding-top20px;">	<!-- 현재 중간라인엔 로그인 양식이 들어감  -->
		<form method="post"	action="loginAction.jsp"><!-- 이 안에는 하나의 form 양식이 들어간다. post는 회원가입,로그인 등..의 어떠한 정보를 숨기면서  보낼떄 쓰는 메소드 라고 할 수 있음. -->
