...
public static void main(String[] args) {
	//요일은 1부터 시작하기 때문에,DAY_OF_WEEK[0]은 비워뒀다.
	...
	System.out.println("date1은" + toString(date1)+DAY_OF_WEEK[date1.get(Calendar.DAY_OF_WEEK)]+"요일이Go,");
	...
	System.out.println("일(day)로 계산하면 " + difference / (24*60*60) + "일이요."); //1일
