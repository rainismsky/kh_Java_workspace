...
<form method="post" action="/MVC_All/logon2/modifyPro.do" name="userinput" onsubmit="return checkIt()">
...
<tr>
<td colspan="2" class="normal" align="center">회원의 정보를 수정한다.</td>
</tr>
<tr>
...
<input type="hidden" name="id" value="${sessingScope.memId}">
</tr>
...
<input type="button" value="취 소" onclick="document.location.href='/MVC_All/logon2/main.do'">
</td>
</tr>
</table>
