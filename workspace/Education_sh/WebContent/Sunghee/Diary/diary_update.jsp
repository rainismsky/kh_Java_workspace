...
<body>
<a href="/Education/Diary/dairy_content.do?d_num=${article.d_num}">뒤로</a>
<br><br>
<form method="get" action="/Education/Diary/dairy_updatePro.do" onsubmit="return checking()" name="userinput">
	...
	<table border="1" cellpadding="0" cellspacing="0">
		<tr>
			<td><input type="date" name="input_date" min="2005-01-01" max="${now_year}-12-31" value="${set_date}" required></td>
		</tr>
		<tr>
			<td><input type="text" name="d_subject" width="#" value="${article.d_subject}" required></td>
		</tr>
		
		<tr>
			<td><textarea name="d_content" id="summernote" required>${article.d_content}</textarea></td>
		</tr>
		<tr>
