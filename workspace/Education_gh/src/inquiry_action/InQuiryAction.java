...
public class InQuiryAction implements CommandAction { //글목록 처리
    ...
    public String requestPro(HttpServletRequest request,HttpServletResponse response)throws Throwable {
        ...
        InQuiryDBBean dbPro = InQuiryDBBean.getInstance();//DB연동
        ...
        return "/geunho/inquiry/inquiry_list.jsp";//해당 뷰
    }
}