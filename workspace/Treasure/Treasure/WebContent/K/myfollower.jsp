...
<div class="right2" style="display: inline; float: left; position: absolute; margin-left: 0px; left: 35%; top: 190px;">
         ...
         <div class="row" style="left:300px; width: 900px;">
         <br><br>
...
<button type="submit" class="btn btn-secondary btn-lg" onclick="openModify()" style = "width : 200px;">회원정보수정</button></form>
        ...
        <hr>
        <table><tr><td><center><h3>나의 팔로워</h3></center></td></tr></table>
        </div>
        
        <div style="position : absolute; margin-top : 83%; width:800;">
        
       
        <c:forEach var="item" items="${fwlist}">
			<div class="col-md-3">
				<a href="/Treasure/J/otherfeed.do?user_id=${item.user_id}"><img src="${pageContext.request.contextPath}${item.user_photo}" style="width:180px; height:180px;" class="img-responsive img-circle" /></a>
				<br/>
