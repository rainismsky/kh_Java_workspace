    ...
    <div class="container">
    	<div class="row">
    	    <div class="col-xs-12">
                ...
                <div class="jumbotron">
  <center><h2 class="display-5">Welcome</h2>
  <p class="lead"><h3>${sessionScope.memId} 님이<br><br>방문하셨습니다.</h3></p></center>
  
</div>
<hr>                
                        <form method="post" action="/Treasure/K/logout.do">
                        <input type="button" id="btn-login" class="btn btn-custom btn-lg btn-block" value="회원정보수정"
                        onclick="document.location.href='/Treasure/K/modify.do'">
                        
                        <input type="submit" id="btn-login" class="btn btn-custom btn-lg btn-block" value="로그아웃">
