...
<div class="page">
	...
	<div class="right2">
		...
		<div class="likee" style="height: 400px;">
			...
			<div style="position: relative; float:left; font-size: 37px;">좋아요</div>
				...
				<div style=" position: relative; right: 25px; float: right;"><img src="../images/painteddia.png" style="width:20px;">${likee.countedLike } </div> <br>
				</a>
				</td>
				<c:if test="${i%j == j-1 }">
				</tr>
